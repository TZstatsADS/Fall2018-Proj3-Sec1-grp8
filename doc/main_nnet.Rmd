...
```{r}
load(file="../output/xgb_psnr.RData")
load(file="../output/psnr_nnet.RData")
load(file="../output/psnrGBM.RData")
#snGBM <- sn
#save(snGBM, file="../output/psnrGBM.RData")


#df <- data.frame(NeuralNetwork=psnr,XGBoost=sn,GBM=snGBM)
#data <- melt(df)
#ggplot(data,aes(x=value, fill=variable)) + geom_density(alpha=0.2)
